...
const products = [
  { name: 'Koyun MFT', description: 'Get a better understanding of your traffic', to: '/Product', icon: ChartPieIcon },
  { name: 'Profesional Services', description: 'Speak directly to your customers', to: '#', icon: CursorArrowRaysIcon },
  { name: 'Security Assesment', description: 'Your customers’ data will be safe and secure', to: '/Product', icon: FingerPrintIcon },
  { name: 'IT Strategy & Consulting', description: 'Connect with third-party tools', to: '#', icon: SquaresPlusIcon },
  { name: 'Automation Engineering', description: 'Build strategic funnels that will convert', to: '#', icon: ArrowPathIcon },
]
const callsToAction = [
